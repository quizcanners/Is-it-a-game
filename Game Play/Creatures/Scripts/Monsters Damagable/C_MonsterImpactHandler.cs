...
namespace QuizCanners.IsItGame.Develop
{
    ...
    {
        private C_MonsterDetailed monster;
        ...
        void OnCollisionEnter(Collision collision)
        {
            ...
            if (magn > 3f)
            {
                ...
                if (magn > 13) 
                {
                    ...
                    if (!monster)
                        monster = GetComponentInParent<C_MonsterDetailed>();

                    if (monster && monster.LimbsState == C_MonsterDetailed.LimbsControllerState.Ragdoll) 
                    {
